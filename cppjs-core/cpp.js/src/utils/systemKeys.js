const systemKeys = {
    ...
    WASI_SDK_PATH: {
        description: 'Path to an extracted wasi-sdk (>= 34, wasm32-wasip3 sysroot) used by platform:\'wasi\' builds. The CPPJS_WASI_SDK_PATH environment variable overrides it.',
        default: '',
    },
};
