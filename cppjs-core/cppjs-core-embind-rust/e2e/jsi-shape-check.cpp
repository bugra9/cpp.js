...
void cppjs_embind_register_optional(CppjsTid, CppjsTid) {
...
extern "C" void cppjs_embind_raise_error(void* w) {
...
static MockFn make_invoker(bool hasThis, unsigned argc, const CppjsTid* argTypes,
                           CppjsFn invoker, void* ctx) {
    const void* tidStr = cppjs_tid_std_string();
    const void* tidInt = cppjs_tid_int();
    const void* tidI64 = cppjs_tid_int64();
    const void* tidU64 = cppjs_tid_uint64();
    ...
    return [=](const std::vector<MockValue>& a) -> MockValue {
        ...
        if (userArgc == 0) {
            ...
            if (hasThis && (retT == cppjs_tid_optional_int() || retT == cppjs_tid_optional_string())) {
...
void cppjs_embind_register_class(
    CppjsTid cls, CppjsTid, CppjsTid, CppjsTid,
    const char*, CppjsFn, const char*, CppjsFn, const char*, CppjsFn,
    const char* name, const char*, CppjsFn dtor) {
...
void cppjs_embind_register_class_constructor(
    CppjsTid cls, unsigned argc, const CppjsTid*,
    const char*, CppjsFn invoker, CppjsFn ctor) {
...
void cppjs_embind_register_class_function(
    CppjsTid cls, const char* name, unsigned argc, const CppjsTid* argTypes,
    const char*, CppjsFn invoker, void* ctx,
...
void cppjs_embind_register_class_class_function(
    CppjsTid cls, const char* name, unsigned argc, const CppjsTid* argTypes,
    const char*, CppjsFn invoker, CppjsFn method, bool, bool /*isNonnullReturn DROPPED*/) {
...
void cppjs_embind_register_function(
    const char* name, unsigned argc, const CppjsTid* argTypes,
    const char*, CppjsFn invoker, CppjsFn function, bool, bool /*isNonnullReturn DROPPED*/) {
...
void cppjs_embind_register_smart_ptr(
    CppjsTid, CppjsTid pointee_ty, const char* name, int,
    const char*, CppjsFn, const char*, CppjsFn, const char*, CppjsFn,
    const char*, CppjsFn destructor) {
...
void cppjs_embind_register_enum(CppjsTid, const char* name, size_t, bool, int /*policy DROPPED*/) {
    std::printf("[jsi-mock] register_enum %s\n", name);
}
void cppjs_embind_register_enum_value(CppjsTid, const char* name, int value) {
...
void cppjs_embind_register_value_object(CppjsTid, const char* name, const char*, CppjsFn, const char*, CppjsFn) {
    std::printf("[jsi-mock] register_value_object %s\n", name);
}
void cppjs_embind_register_value_object_field(CppjsTid, const char* name, CppjsTid, const char*, CppjsFn, void*, CppjsTid, const char*, CppjsFn, void*) {
    std::printf("[jsi-mock] register_value_object_field %s\n", name);
}
void cppjs_embind_finalize_value_object(CppjsTid) {
