...
const includes = [
    join(own, 'include'),
    join(depDist('@crossbind/port-tiff-wasi'), 'include'),
];
const archives = [
    ...
    join(depDist('@crossbind/port-tiff-wasi'), 'lib', 'libtiff.a'),
    join(depDist('@crossbind/port-proj-wasi', '@crossbind/port-sqlite3-wasi'), 'lib', 'libsqlite3.a'),
