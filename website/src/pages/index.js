  ...
  return (
    <Layout description="Bind c++ libraries to js on web and mobile.">
      ...
      <div className={clsx('hero hero--primary mt-12 mb-12', styles.heroBanner)}>
        <div className="container home-markdown text-base text-justify">
          <SeamlessIntegration />
        </div>
      </div>
    </Layout>
