// Plain Rust - no crossbind coupling. The toolchain parses this pub surface and generates the
// embind bridge as a companion crate (.crossbind/bridge-crate), the Rust analog of C++ .i.cpp files.
