...
describe('getParentPath', () => {
    ...
    test('strips the file segment from a file:// URL', () => {
        const input = pathToFileURL(upath.resolve('/Users/me/project/core/crossbind/src/index.js')).href;
        expect(getParentPath(input)).toBe(upath.resolve('/Users/me/project/core/crossbind/src'));
    });
