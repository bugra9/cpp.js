...
export const name = 'crossbind_doctor';

export const config = {
    title: 'Check crossbind toolchain prerequisites',
...
export async function handler() {
    ...
    if (!root) return error('crossbind repo not found from cwd. Set the MCP working directory to your checkout.');
