...
export const name = 'crossbind_check_native_versions';

export const config = {
    title: 'Check upstream native versions of crossbind packages',
    description: 'Compare each port\'s nativeVersion against the latest upstream release (GitHub releases / tags / project HTML download index). With update=true, auto-bump every package.json that\'s behind. Must run from inside the crossbind monorepo.',
    inputSchema: {
